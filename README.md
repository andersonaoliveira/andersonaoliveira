<div align="center">
  <h1>Bem-vindo(a) ao Perfil de Anderson de Aguiar de Oliveira</h1>
...
<p align="center">
  <img src="https://streak-stats.demolab.com/?user=andersonaoliveira&theme=dark" alt="GitHub Streak" />
</p>
...
Possuo conhecimento aprofundado em mensageria (RabbitMQ, Kafka, SNS), bancos de dados relacionais como PostgreSQL e MySQL, e não-relacionais como MongoDB. Sou proficiente em práticas como Clean Code, TDD, APIs RESTful e princípios SOLID, com experiência em integração com sistemas embarcados e plataformas IoT.

Minha trajetória inclui uma bem-sucedida transição do Direito para a Tecnologia, o que me proporcionou grande resiliência, capacidade de aprendizado contínuo e habilidade de liderança técnica.
...
* Integração com AWS (EC2, S3, RDS) e plataformas IoT.
* Aplicação de práticas como Clean Code, testes automatizados e pipelines CI/CD.
* Orientação técnica de times ágeis em soluções backend escaláveis.

### Locaweb | Analista de Sistemas I (Ago/2022 - Dez/2022)
* Desenvolvimento de APIs RESTful com Ruby on Rails.
* Utilização de Docker, RabbitMQ e PostgreSQL em ambiente cloud (Azure).

### Compass UOL | Treinamento em Desenvolvimento (Mai/2022 - Ago/2022)
* Projetos com Docker, MongoDB, Node.js, Python e Chatbot com RASA.
* Desenvolvimento de aplicações em cloud e uso de mensageria com filas.

### Bancos N26, Cielo e Stone | Consultor de Software (Jan/2020 - Ago/2022)
* Consultoria e desenvolvimento de software para grandes empresas do setor financeiro e de pagamentos (Cielo, N26, Stone).
* Foco em arquitetura e implementação de microsserviços escaláveis com Java e Spring Boot.
* Responsável pela criação de APIs RESTful seguras e otimização de performance em sistemas de missão crítica.

### Ordem dos Advogados do Brasil | Advogado (Ago/2011 - Jan/2021)
* Sólida atuação jurídica antes da transição para TI.
* Desenvolvimento de resiliência, comunicação e liderança.

### CTA - Centro Tecnológico Avançado | Desenvolvedor (Ago/2010 - Jan/2018)
...
São Paulo, SP - Brasil, Junho de 2025.
